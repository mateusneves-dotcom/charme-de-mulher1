    ...
    <div className="checkout">
      ...
      <label>Forma de pagamento
        <select value={payment} onChange={(e) => setPayment(e.target.value)}>
          <option>Pix</option><option>Cartão</option><option>Dinheiro na entrega</option>
        </select>
      </label>
...
function SettingsForm({ config, onSave }) {
  ...
  const saveGeneral = async () => {
    await onSave({ ...config, whatsappNumber: onlyDigits(whatsapp), pixKey: pix, sobreTexto: about });
